...
If FAULTS is downloaded as a separate Windows program, it should be launched from a DOS window, after having copied the standard scattering factor data file \textit{data.sfc} into the working folder.
