...
subroutine Get_Friedel_pairs_number
 ...
 implicit none
  ...
  WRITE(message_text, '(a,I8)')   '  . Number of valid Friedel pairs            : ', n_ok_c - n_ok_nc
  call write_info(TRIM(message_text))
  WRITE(message_text, '(a,I8)')   '  . Number of valid Friedel pairs with I>2sig: ', n_ok_2_c - n_ok_2_nc
  call write_info(TRIM(message_text))
