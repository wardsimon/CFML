...
!                                     $n: numero de l'operateur de symetrie (dans la liste) a appliquer a l'atome
 use cryscalc_module, ONLY      : R => symm_op_rot,  T => symm_op_trans, nb_dist_calc, nb_symm_op,              &
...
subroutine write_UB_matrix
 USE cryscalc_module,          only  : tmp_unit, UB_matrix, message_text, debug_proc
...
subroutine density_calculation()
 USE cryscalc_module, ONLY        : ON_SCREEN, molecule, Z_unit, unit_cell, keyword_create_CIF, CIF_unit, message_text, &
                                    debug_proc
 USE IO_module
