...
del *.map
      ...
      lf95 -c IO_console           -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      lf95 -c text_mod             -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
...
rem   lf95 -c cryscalc_ext         -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
...
rem   lf95 -c shannon_mod          -o1 -info                                  -nchk  -nstchk   < now included in atom_mod.F90
rem   lf95 -c mag_table            -o1 -info                                  -nchk  -nstchk   < now included in atom_mod.F90
      lf95 -c calculs              -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      lf95 -c therm                -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      lf95 -c cryscalc_sfac        -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk

      lf95 -c cryscalc_dist        -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      ...
      lf95 -c cryscalc_symm        -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      lf95 -c space_group          -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      lf95 -c transf               -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      lf95 -c cryscalc_main_lf95   -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      lf95 -c cryscalc             -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
...
REM
      ...
      lf95 -c cryscalc_init        -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      lf95 -c inter_cons           -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      lf95 -c read_CFL             -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      lf95 -c read_INS             -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      ...
      lf95 -c create_CFL           -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      ...
      lf95 -c sort                 -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
      ...
      lf95 -c cryscalc_write       -o1 -info  -mod  .;%CRYSFML%\Lahey\libC    -nchk  -nstchk
 ...
 lf95 -out cryscalc *.obj   -mod %CRYSFML%\lahey\libC -lib %CRYSFML%\lahey\libC\crysfml
rem upx cryscalc.exe
