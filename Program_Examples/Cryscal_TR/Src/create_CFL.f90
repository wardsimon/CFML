...
subroutine create_CFL_file(input_file, extension)
 ...
 implicit none
  ...
  if(i1 /=0) then
   ...
   WRITE(created_CFL_file, '(a)') 'cryscal_.CFL'
  end if  
...
subroutine create_FST_file(input_file, extension)
 ...
 implicit none
  ...
  if(i1 /=0) then
   ...
   WRITE(created_FST_file, '(a)') 'cryscal.FST'
  endif  
...
! USE CFML_IO_FORMATS, ONLY : Write_Shx_Template
 ...
 implicit none
  ...
  if(input_file(1:11) == 'cryscal.ins') then
   created_INS_file = 'cryscal.ins'
  else
   i= INDEX(input_file, '.')
...
subroutine create_TIDY_file(input_file, extension)
 ...
 implicit none
  ...
  if(i1 /=0) then
   ...
   WRITE(TIDY_file, '(a)') 'cryscal_tidy.dat'
  end if  
