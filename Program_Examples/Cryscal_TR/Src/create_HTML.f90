...
USE cryscal_module,               ONLY : nb_help_max, help_string, HTML_unit, browse_cryscal_HTML, my_browser, &
                                         cryscal_version, cryscal_author, max_ref, debug_proc
USE text_module
...
implicit none
 ...
 if(debug_proc%level_2)  call write_debug_proc_level(2, "create_CRYSCAL_HTML")
 ...
 OPEN(UNIT=HTML_unit, FILE='cryscal.HTML')
  ...
  call write_HTML_css(HTML_unit, 'cryscal')
  ...
  WRITE(HTML_unit, '(a)') '<li class="item_2"><A HREF="#cryscal_linux">&nbsp;&nbsp;Linux version</a>'
  WRITE(HTML_unit, '(a)') '</ul>'
  WRITE(HTML_unit, '(a)') ''
  WRITE(HTML_unit, '(a)') '</p>'
...
! --------------- setting file -----------------------------------
  ...
  WRITE(HTML_unit, '(a)') '    include_RES_file             = 1         ! include .RES file in the archive_cryscal.cif file'
...
! ----------------------------------------------------------------
  ...
  WRITE(HTML_unit, '(a)') '<ul>'
  WRITE(HTML_unit, '(2a)') ' <li class="item"><a href="http://www.cdifx.univ-rennes1.fr/progs/cryscal/rint.cfl">', &
  ...
  WRITE(HTML_unit, '(2a)') ' <li class="item"><a href="http://www.cdifx.univ-rennes1.fr/progs/cryscal/cryscal_si_x_100.cfl">', &
  ...
  WRITE(HTML_unit, '(2a)') ' <li class="item"><a href="http://www.cdifx.univ-rennes1.fr/progs/cryscal/cryscal_y2o3_bvs.cfl">', &
...
! ----------------------------------------------------------------
  ...
  WRITE(HTML_unit, '(a)') '<ul>'
  WRITE(HTML_unit, '(2a)') ' <li class="item"><a href="http://www.cdifx.univ-rennes1.fr/progs/cryscal/cryscal.exe">', &
  ...
  WRITE(HTML_unit, '(2a)')' <li class="item"><a href="http://www.cdifx.univ-rennes1.fr/progs/cryscal/cryscal.css">', &
                          "Example of CSS file for HTML user's guide</a>"
  WRITE(HTML_unit, '(a)') '<p>'
  WRITE(HTML_unit, '(2a)')' <li class="item"><a href="http://www.cdifx.univ-rennes1.fr/progs/cryscal/cryscal_report.css">', &
  ...
  ! ----------------------------------------------------------------
  WRITE(HTML_unit, '(a)') '<br>'
  WRITE(HTML_unit, '(a)') '<A NAME="cryscal_linux"></A><p class="title_1">&nbsp;&nbsp;CRYSCAL under Linux:<br></p>'
  WRITE(HTML_unit, '(a)') '<ul>'
  WRITE(HTML_unit, '(2a)')' <li class="item"><a href="http://www.cdifx.univ-rennes1.fr/progs/cryscal/linux/readme.txt">', &
                          ' Readme.txt</a>'
  WRITE(HTML_unit, '(a)') '<p>'
  WRITE(HTML_unit, '(2a)')' <li class="item"><a href="http://www.cdifx.univ-rennes1.fr/progs/cryscal/linux/cleaned.sh">', &
                          ' Script for compilation</a>'
  WRITE(HTML_unit, '(a)') '<p>'
  WRITE(HTML_unit, '(2a)')' <li class="item"><a href="http://www.cdifx.univ-rennes1.fr/progs/cryscal/linux/cryscal_init_linux.', &
                          'f90">cryscal_init_linux.f90</a>'
  WRITE(HTML_unit, '(a)') '<p>'
  WRITE(HTML_unit, '(2a)')' <li class="item"><a href="http://www.cdifx.univ-rennes1.fr/progs/cryscal/linux/cryscal_linux">', &
                          'cryscal_linux (executable)</a>'
  WRITE(HTML_unit, '(a)') '<p>'
  ...
  WRITE(HTML_unit, '(3a)') "<p class='retrait_2'>last updated: <i>TR / CDIFX - ", trim(cryscal_version), "</i></P>"
...
subroutine write_HTML_css(HTML_unit, input_string)
 use cryscal_module, only : tmp_unit, cryscal_css, cryscal_report_css, debug_proc
 implicit none
  integer, intent(in)           :: HTML_unit
  character (len=*), intent(in) :: input_string  !  input_string = cryscal / report
  ...
  if(input_string == 'cryscal') then
   css_file = cryscal_css
  elseif(input_string == 'report') then
   css_file = cryscal_report_css
  endif
