...
subroutine read_SHELX_HKL(input_string)
 ...
 USE cryscal_module, ONLY  : P4P_file_name, HKL_file_name, keyword_P4P, message_text, hkl_format, HKL_SHELX_format, debug_proc
...
! lecture fichier.RAW cree par SAINT
 USE IO_module,      ONLY  : write_info
 USE HKL_module
 USE cryscal_module, ONLY  : RAW_file_name, message_text, debug_proc
