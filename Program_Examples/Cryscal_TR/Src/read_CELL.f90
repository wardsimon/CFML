...
! . creation apex.cif
 ...
 USE IO_module
 USE cryscal_module, ONLY : P4P_file_name, message_text, keyword_CELL, input_line, lecture_OK, debug_proc 
 implicit none
...
subroutine read_M50_file(M50_file, lecture_ok)
 USE cryscal_module, ONLY : M50_read_unit, unit_cell, known_cell_esd, wavelength, keyword_WAVE, debug_proc
...
subroutine read_RED_input_file(RED_file, lecture_ok)
 USE cryscal_module,                   ONLY : RED_read_unit, unit_cell, known_cell_esd, wavelength, keyword_WAVE, SPG, &
...
subroutine read_X_input_file(X_file, lecture_ok)
 USE cryscal_module, ONLY : X_read_unit, unit_cell, wavelength, keyword_WAVE, debug_proc
 USE macros_module,  ONLY : test_file_exist
...
subroutine read_RMAT_input_file(RMAT_file, lecture_ok)
 USE cryscal_module, ONLY : RMAT_read_unit, unit_cell, debug_proc
 USE macros_module,  ONLY : test_file_exist
