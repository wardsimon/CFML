...
!------------------------------------------------------------------
 ...
 subroutine calcul_connectivity_atom
  use cryscal_module,                 ONLY : keyword_create_CIF, CIF_DIST, CONN_all, CONN_all_X, CONN_self, nb_atom, atom_CONN,  &
                                             CONN_species, CONN_out, calcul_BVS,                                                 &
  ...
  implicit none
   ...
   character(len=8)                   :: current_atom, atome_type
   logical                            :: atom_ok
   ! BVS
...
subroutine write_dist_CIF(read_line)
 use cryscal_module, only : CIF_unit
!    
  implicit none
