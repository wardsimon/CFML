...
del *.map
      ...
      lf95 -c cryscal_mod       -o1 -info  -mod  .;%CRYSFML%\Lahey\libC             -nchk  -nstchk
      ...
      lf95 -c cryscal_ext       -o1 -info  -mod  .;%CRYSFML%\Lahey\libC             -nchk  -nstchk
      ...
      lf95 -c cryscal_main_lf95 -o1 -info  -mod  .;%CRYSFML%\Lahey\libC             -nchk  -nstchk
      lf95 -c cryscal           -o1 -info  -mod  .;%CRYSFML%\Lahey\libC             -nchk  -nstchk
