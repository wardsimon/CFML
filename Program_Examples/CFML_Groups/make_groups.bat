...
:IFORT
   ...
   ifort /c CFML_Groups.f90  /O2 /Qparallel /nologo /IC:\CrysFML\ifort\LibC
   ifort /c groups.f90       /O2 /Qparallel /nologo /IC:\CrysFML\ifort\LibC
   ifort /exe:groups *.obj C:\CrysFML\ifort\LibC\crysfml.lib
rem   link /subsystem:console /out:get_standard.exe *.obj C:\CrysFML\ifort\LibC\crysfml.lib
   goto END
:IFORTD
   ifort /c CFML_Groups.f90  /debug:full /check:noarg_temp_created /traceback  /nologo  /heap-arrays:100 /IC:\CrysFML\ifort_debug\LibC
...
:GFOR
   gfortran -c CFML_Groups.f90  -ffree-line-length-0  -I../../GFortran/LibC
