...
rem
   ...
   gfortran -c CFML_io_mess.f90          -O0 -fbacktrace  -std=f2003
...
rem
   gfortran -c CFML_Eos_Mod.f90          -O0 -fbacktrace  -std=f2003
...
rem
rem -std=f2003 removed because calls to flush subroutine
   gfortran -c CFML_optimization_san.f90 -O0 -fbacktrace
