...
rem  is erfc an intrinsic function in  F2003?
   gfortran -c CFML_Profile_TOF.f90      -O0 -ftrace=full                >> out
...
rem -std=f2003 removed because calls to flush subroutine
   gfortran -c CFML_conf_calc.f90        -O0 -ftrace=full                >> out
rem
   echo **---- Level 6 ----**
   echo .... Formats
rem
   gfortran -c CFML_form_cif.f90         -O0 -ftrace=full  -std=f2003    >> out
   gfortran -c CFML_Export_Vtk.f90       -O0 -ftrace=full  -std=f2003    >> out
rem
   echo **---- Level 7 ----**
...
rem -std=f2003 removed because calls to flush subroutine
   gfortran -c CFML_optimization_san.f90 -O0 -ftrace=full                >> out
