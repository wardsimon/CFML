...
rem
   ...
   gfortran -c CFML_io_messwin.f90       -O3 -ffree-line-length-none -std=f2003  -funroll-loops  -msse2 -I"%winter%\lib.gnu"  >> out
...
rem
rem -std=f2003 removed because calls to flush subroutine
   gfortran -c CFML_optimization_san.f90 -O3 -ffree-line-length-none             -funroll-loops  -msse2 -I"%winter%\lib.gnu"  >> out
