rem
rem CrysFML for GFortran Compiler (Optimization) + WINTERACTER
rem
   @echo off
   cd %CRYSFML%\Src
rem
...
rem
   ...
   gfortran -c CFML_LSQ_TypeDef.f90      -O3  -std=f2003  -funroll-loops  -msse2  >> out
   ...
   gfortran -c CFML_io_messwin.f90       -O3  -std=f2003  -funroll-loops  -msse2 -I"%winter%\lib.gnu"  >> out
...
rem
   ...
   gfortran -c CFML_chem_scatt.f90       -O0  -std=f2003  -funroll-loops  -msse2  >> out
   gfortran -c CFML_diffpatt.f90         -O3  -std=f2003  -funroll-loops  -msse2  >> out
rem
   echo **---- Level 2 ----**
   echo .... Bonds, Crystal Metrics, Symmetry, ILL_Instr
rem
   gfortran -c CFML_bonds_table.f90      -O0  -std=f2003  -funroll-loops  -msse2  >> out
   gfortran -c CFML_cryst_types.f90      -O3  -std=f2003  -funroll-loops  -msse2  >> out
   gfortran -c CFML_symmetry.f90         -O3  -std=f2003  -funroll-loops  -msse2  >> out
...
rem
rem -std=f2003 removed because calls to flush subroutine
   gfortran -c CFML_optimization_san.f90 -O3              -funroll-loops  -msse2 -I"%winter%\lib.gnu"  >> out
...
rem
   ...
   if exist ..\GFortran\LibW rmdir ..\GFortran\LibW /S /Q
   mkdir ..\GFortran\LibW
rem
   copy *.mod ..\GFortran\LibW > nul
   move *.a   ..\GFortran\LibW > nul
