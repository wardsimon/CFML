...
rem
   ...
   ifort /c CFML_io_messwin.f90       /debug:full /check /traceback /CB /nologo /Qvec-report0 /I%WINTER%\%LIBFOR%
...
rem
   ...
   ifort /c CFML_optimization_san.f90 /debug:full /check /traceback /CB /nologo /Qvec-report0 /I%WINTER%\%LIBFOR%
