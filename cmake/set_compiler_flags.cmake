    ...
    if(COMPILER_NAME STREQUAL ifort)
        ...
        if(WIN32)
            if(CMAKE_BUILD_TYPE STREQUAL Debug)
                if(USE_HDF)
                   set(CMAKE_Fortran_FLAGS_DEBUG "/debug:full /traceback /nologo /fpp /DUSE_HDF /Qopt-report=0")
                else()
...
#               set(CMAKE_Fortran_FLAGS_DEBUG "/debug:full /traceback /nologo")
            ...
            elseif(CMAKE_BUILD_TYPE STREQUAL Release)
                if(USE_HDF)
                   set(CMAKE_Fortran_FLAGS_RELEASE "/Qopt-report=0 /nologo /fpp /DUSE_HDF")
                else()
...
#               set(CMAKE_Fortran_FLAGS_RELEASE "/Qopt-report=0 /nologo")
        ...
        elseif(APPLE)
            if(CMAKE_BUILD_TYPE STREQUAL Debug)
                if(USE_HDF)
                   set(CMAKE_Fortran_FLAGS_DEBUG "-g -warn -traceback -cpp -DUSE_HDF -qopt-report=0")
                else()
    ...
    elseif(COMPILER_NAME STREQUAL gfortran)
        ...
        if(WIN32)
            if(CMAKE_BUILD_TYPE STREQUAL Debug)
                ...
                set(OPT_FLAGS2 "-O0")
                if(USE_HDF)
                   set(CMAKE_Fortran_FLAGS_DEBUG "-fbacktrace -cpp -DUSE_HDF -ffree-line-length-none")
                else()
        ...
        elseif(APPLE)
            if(CMAKE_BUILD_TYPE STREQUAL Debug)
                set(CMAKE_Fortran_FLAGS_DEBUG "-cpp -Wall -m32 -ffree-line-length-none")
                set(OPT_FLAGS "-g")
                set(OPT_FLAGS1 "-g")
            elseif(CMAKE_BUILD_TYPE STREQUAL Release)
                set(CMAKE_Fortran_FLAGS_RELEASE "-cpp -m32 -ffree-line-length-none")
                set(OPT_FLAGS "-O3")
                set(OPT_FLAGS1 "-O0")
            endif()
        else()
            if(CMAKE_BUILD_TYPE STREQUAL Debug)
                ...
                set(OPT_FLAGS2 "-g")
                if(USE_HDF)
                   set(CMAKE_Fortran_FLAGS_DEBUG "-cpp -DUSE_HDF -ffree-line-length-none")
                else()
