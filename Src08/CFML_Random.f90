...
!!
 Module CFML_Random_Generators
    ...
    public  :: random_beta,           random_binomial1,    random_binomial2,   random_cauchy,  &
               random_chisq,          random_exponential,  random_gamma,       random_gamma1,  &
               random_gamma2,         random_inv_gauss,    random_neg_binomial,random_normal,  &
               random_poisson,        random_t,            random_von_mises,   random_weibull, &
               random_mvnorm,         random_order,                                            &
               seed_random_number
