...
Program Magnetic_Hall
   ...
   do n=1,1651
      ...
      nt=nt+1
      Litvin_to_IT(n)=ik
      !if (trim(spg%bns_symb) /= trim(str_BNS)) then
      !   write(unit=*,fmt='(i6,i6,t18,a,t40,a,t60,a)') nt, ik,str_BNS, spg%bns_symb, 'ERROR'
      !else
         write(unit=*,fmt='(i6,i6,t18,a,t40,a,t60,a)') nt, Litvin_to_IT(n), str_BNS, Mag_symb(ik)%BNS, Mag_symb(n)%BNS
      !end if
