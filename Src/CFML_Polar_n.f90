...
!!---- Juan Rodriguez-Carvajal & Marc Janoschek & some modifications by Oksana Zaharko
!!----
...
!!----
!!---- HISTORY
!!----    Update: January  - 2011: Suppression of redundant type Polar_Info_Type
!!----                             General revision of variables introduced by OZ (JRC)
!!----            April    - 2008
...
!!----
!!----    Subroutines:
!!----       CALC_POLAR_DOM  (OZ adapted from SET_POLAR_INFO by including domain information)
!!----       SET_POLAR_INFO  (OZ replaced by Calc_Polar_Dom, Feb 2009. Useful only for theoretical monodomains)
!!----       WRITE_POLAR_INFO
!!----       WRITE_POLAR_LINE
!!----
!!
