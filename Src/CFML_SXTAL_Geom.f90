    ...
    Subroutine Read_Twinlaw(Twin,read_ok,lun,fich_cfl)
      ...
      do
        ...
        if(present(lun)) then
          ...
          if(ier /= 0) then
            if(ier < 0) exit
            write(unit=ERR_SXTGeom_Mess,fmt="(a,i5)") " => Error reading in the input file, at line: ",n_lin
            ERR_SXTGeom=.true.
            exit
          end if
        ...
        if(line(1:8) == "TWIN_nam") then
          ...
          if(ier /= 0) then
            ERR_SXTGeom_Mess=" => Error reading the TWIN law file, item: TWIN_typ"
            ERR_SXTGeom=.true.
            return
          end if
          ...
          if(Twin%ityp < 1 .or. Twin%ityp > 4) then
            ERR_SXTGeom_Mess=" => Illegal TWIN_typ: It should be 1, 2, 3 or 4!"
            ERR_SXTGeom=.true.
           return
          end if
          ...
          if(ier /= 0) then
            ERR_SXTGeom_Mess=" => Error reading the TWIN law file, item: TWIN_rot"
            ERR_SXTGeom=.true.
            return
          end if
          ...
          if(ier /= 0) then
            ERR_SXTGeom_Mess=" => Error reading the TWIN law file, item: TWIN_uma"
            ERR_SXTGeom=.true.
            return
          end if
          ...
          if(ier /= 0) then
            ERR_SXTGeom_Mess=" => Error reading the TWIN law file, item: TWIN_mat"
            ERR_SXTGeom=.true.
            return
          end if
      ...
      if(Twin%ityp == 0 .and. Twin%N_twins > 1) then
         ERR_SXTGeom_Mess=" => Error: The type of twin is unknown! TWIN_typ not given!"
         ERR_SXTGeom=.true.
         return
      end if
      read_OK=.true.
    ...
    Subroutine Write_Twinlaw(Twin,lun,cell)
      ...
      !---------------------------------------
        if(present(cell)) then
           ...
           ERR_SXTGeom_Mess=" => Error: fow TWIN_typ=3, cell must be given!"
           ERR_SXTGeom=.true.
        end if
      !----------------------------------
      End If
