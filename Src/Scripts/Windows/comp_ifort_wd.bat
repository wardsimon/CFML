...
rem
   ...
   ifort /c CFML_io_messwin.f90       /debug:full /check /traceback /nologo /Ic:\wint\lib.if8
...
rem
   ...
   ifort /c CFML_optimization_san.f90 /debug:full /check /traceback /nologo /Ic:\wint\lib.if8
