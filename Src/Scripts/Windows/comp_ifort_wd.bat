...
rem
   ...
   ifort /c CFML_io_messwin.f90       /debug:full /check /traceback /CB /nologo /Qvec-report0 /Ic:\wint\lib.if8
...
rem
   ...
   ifort /c CFML_optimization_san.f90 /debug:full /check /traceback /CB /nologo /Qvec-report0 /Ic:\wint\lib.if8
...
rem
   if not exist ..\..\Intel_debug mkdir ..\..\Intel_debug
   if exist ..\..\Intel_debug\LibW rmdir ..\..\Intel_debug\LibW /S /Q
   mkdir ..\..\Intel_debug\LibW
rem
   copy *.mod ..\..\Intel_debug\LibW > nul
   move *.lib ..\..\Intel_debug\LibW > nul
