...
rem
   ...
   cd ../../cfgl
rem
   ifort /c WCFGL_constant.f90           /O2 /nologo /Qvec-report0 /I. /I..\..\Intel\LibW
   ifort /c WCFGL_atomic_table.f90       /O2 /nologo /Qvec-report0 /I. /I..\..\Intel\LibW
   ifort /c WCFGL_objects_definition.f90 /O2 /nologo /Qvec-report0 /I. /Ic:\wint\lib.if8
