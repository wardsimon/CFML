...
!!
 ...
 Contains
    ...
    !!
    Subroutine Readn_Set_Magnetic_Structure_MCIF(file_mcif,mCell,MGp,Am,ordered)
       character(len=*),               intent (in)  :: file_mcif
       type(Crystal_Cell_type),        intent (out) :: mCell
       type(Magnetic_Space_Group_Type),intent (out) :: MGp
       type(mAtom_List_Type),          intent (out) :: Am
             ...
             Case("loop_")
                 ...
                 Select Case(trim(keyword))
                   ...
                   Case("_magnetic_space_group_symop_id")
                      !write(unit=*,fmt="(a)") "  Treating item: _magnetic_space_group_symop_id"
                      do k=1,3
                        i=i+1
                   ...
                   Case("_magnetic_atom_site_moment_label","_atom_site_moment_label")
                      !write(unit=*,fmt="(a)") "  Treating item: _atom_site_moment_label"
                      do k=1,3
                        i=i+1
                        if(index(mcif%line(i),"_atom_site_moment_crystalaxis") == 0 ) then
                          err_magsym=.true.
       ...
       !do i=1,MGp%Multip
       !  write(*,"(i3,t20,a,t55,a)") i,MGp%SymopSymb(i),MGp%MSymopSymb(i)
       !end do
       Call cleanup_symmetry_operators(MGp,ordered)
