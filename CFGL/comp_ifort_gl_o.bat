@echo off
rem
ifort /c WCFGL_constant.f90           /Ox /nologo /I. /I..\..\Intel\LibW >out
ifort /c WCFGL_atomic_table.f90       /Ox /nologo /I. /I..\..\Intel\LibW >>out
ifort /c WCFGL_objects_definition.f90 /Ox /nologo /I. /Ic:\wint\lib.if8  >>out
ifort /c WCFGL_geometry.f90           /Ox /nologo /I. /I..\..\Intel\LibW >>out
ifort /c WCFGL_Chull3D.f90            /Ox /nologo /I. /Ic:\wint\lib.if8  >>out
ifort /c WCFGL_quaternion.f90         /Ox /nologo /I. /I..\..\Intel\LibW >>out
